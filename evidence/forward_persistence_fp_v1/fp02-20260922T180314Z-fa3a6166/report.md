# FP-02 — Evaluator and reusable runtime (fp02-20260922T180314Z-fa3a6166)

- run_dir: /root/bobby/pool_alpha/lab_regime_model_quantbt/evidence/forward_persistence_fp_v1/fp02-20260922T180314Z-fa3a6166
- started_at: 2026-09-22T18:03:14.625199+00:00
...
- first: {'status': 'HIT', 'producer': 'fp02-20260922T175825Z-82d4405b-a'}
...
- changed economics (different fee rate): {'status': 'HIT', 'terminal_equity_changed': True}
...
- per-activation bar ranges:
  ...
  - fp02-20260922T180314Z-fa3a6166-initial: bar_range=[8, 7211] fills=134
  - sentinel:WARMING: bar_range=[7211, 7222] fills=0
  - fp02-20260922T180314Z-fa3a6166-switch: bar_range=[7222, 14400] fills=59

## FP02-G-RESUME — cache-based resume (no search loop exists yet to checkpoint)
- pre-crash statuses: ['HIT', 'HIT']
- post-resume statuses (fresh ComputeCache instance): ['HIT', 'HIT', 'HIT']
- total engine recomputes across BOTH passes: 0 (of 3 unique candidates -- a naive restart would have recomputed all of them twice)
