...
## 1. Status va scope
- Technical gate: **FAIL**; research status: **DISCOVERY_ONLY** (guide 3.5: no
  positive/edge claim offered; a short pilot cannot be given an economic verdict per RA01.4's
  migration table).
- Branch `mode4-corrective`, guide RA-GUIDE-1.0 (section 9), study `regime_time_edge_ra_v1`, run `ra05-20260918T181151Z-2d9f17fc`.
...
|---|---|---|---|---|
| G05-EXEC | PASS | PASS | ra05-20260918T181151Z-2d9f17fc/phase_manifest.json | PASS |
| G05-TRACE | PASS | FAIL | ra05-20260918T181151Z-2d9f17fc/phase_manifest.json | FAIL |
| G05-LEARN | PASS | PASS | ra05-20260918T181151Z-2d9f17fc/phase_manifest.json | PASS |
| G05-SCOPE | PASS | PASS | ra05-20260918T181151Z-2d9f17fc/phase_manifest.json | PASS |
| G05-MANIFEST | PASS | PASS | ra05-20260918T181151Z-2d9f17fc/phase_manifest.json | PASS |
