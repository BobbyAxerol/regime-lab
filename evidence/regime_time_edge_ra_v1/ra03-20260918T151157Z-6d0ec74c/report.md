...
- Branch `mode4-corrective`, HEAD `0385b20cc3c8337bdb512ffa713f0d9bdd9e2717`, guide RA-GUIDE-1.0 (section 7), study `regime_time_edge_ra_v1`, run `ra03-20260918T151157Z-6d0ec74c`.
...
- Tests: collected 29, failures 0, errors 0; matrix covers M01-M08.

## 4. Exit-gate matrix
| Gate | Expected | Actual | Evidence ref/hash | Status |
|---|---|---|---|---|
| G03-PARITY | M01-M08 pass, no primary-semantics change for speed | PASS | parity_report.json sha256:ab9015456170... | PASS |
| G03-MEM | representative train candidate + deployment scope both measured under cap | PASS | memory_profile.json sha256:a39d45b2a801... | PASS |
| G03-ROUTE | pilot cell has a real qualified route; every alpha keeps a real status | PASS | route_matrix.json sha256:3dea7e7ae4da... | PASS |
| G03-COST | planner forecasts from measurements; admission rejects an over-envelope job | PASS | capacity_forecast.json sha256:8cea46ab5349... | PASS |
| G03-LEDGER | shared TE ledger untouched; protected tree unchanged | PASS | resource_receipts.json sha256:b8b4e536be3c... | PASS |
...
-   - representative_train_candidate: peak 0.319 GiB, growth/extra-repeat 1.22 MiB, under_target_headroom=True, extrapolated=False
  - deployment_scope: peak 0.383 GiB, growth/extra-repeat 4.00 MiB, under_target_headroom=True, extrapolated=False
...
- Measured cost/task: 2.634s (representative train-candidate scope, warm repeat).
- Ledger: budget 300000.0s, charged 193557.80508357903s, remaining 106442.2s -> affords ~40416 more measured-scale tasks at this cost, no unmeasured speedup claimed.
