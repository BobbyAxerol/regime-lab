...
- Technical gate: **PASS**; research status: **DISCOVERY_ONLY** (guide 3.5: no
  ...
  migration table).
- Branch `mode4-corrective`, guide RA-GUIDE-1.0 (section 9), study `regime_time_edge_ra_v1`, run `ra05-20260918T191827Z-e2de8339`.
...
|---|---|---|---|---|
| G05-EXEC | PASS | PASS | ra05-20260918T191827Z-e2de8339/phase_manifest.json | PASS |
| G05-TRACE | PASS | PASS | ra05-20260918T191827Z-e2de8339/phase_manifest.json | PASS |
| G05-LEARN | PASS | PASS | ra05-20260918T191827Z-e2de8339/phase_manifest.json | PASS |
| G05-SCOPE | PASS | PASS | ra05-20260918T191827Z-e2de8339/phase_manifest.json | PASS |
| G05-MANIFEST | PASS | PASS | ra05-20260918T191827Z-e2de8339/phase_manifest.json | PASS |
