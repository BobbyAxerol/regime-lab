...
- Branch `mode4-corrective`, HEAD `161c34a7a1e4e737d3ac0acd58ca85d86c70d925`, guide RA-GUIDE-1.0 (section 6), study `regime_time_edge_ra_v1`, run `ra02-20260918T113952Z-94bd0d32`.
...
- Cross-run reuse: producer `ra02-20260918T113952Z-94bd0d32-a` ran the engine 1 time(s) over 1440 bars; consumer `ra02-20260918T113952Z-94bd0d32-b` got **HIT** with new_engine_runs=0; equivalence `canonical-byte-equal` passed=True.
...
|---|---|---|---|---|
| G02-SEM | C01-C10 ran and passed; cross-run reuse is a real HIT with 0 new engine runs | PASS | cache_test_matrix.json sha256:bf5f5319776e... | PASS |
| G02-NUM | reused output equals the producer's within a frozen tolerance; provenance separated | PASS | actual_cross_run_reuse.json sha256:207d0b131b80... | PASS |
| G02-COUNT | all counters present and consistent; cache-hit bars are never counted as executed | PASS | counters.json sha256:f4a1f01f1bb3... | PASS |
| G02-LEDGER | old attempts/costs intact; phase inside its sub-envelope; protected tree unchanged | PASS | resource_envelope.json sha256:16a2468f580e... | PASS |
...
- Phase wall 2.8s against the frozen sub-envelope 3600.0s. Ledger TE02-PILOT-R03 spent 193557.80508357903 -> 193557.80508357903, attempts 140 -> 140, budget 300000.0: unchanged by this phase.
