...
- **conclusion_level: INCONCLUSIVE_SUPPORT** (registered vocabulary, guide 13.5's claim-gate table;
  ...
  can carry).
- Branch `mode4-corrective`, guide RA-GUIDE-1.0 (section 11), study `regime_time_edge_ra_v1`, run `ra07-20260919T071527Z-4463ccde`.
...
- DELAYED_INFORMATION: OK, equity_last=20859.336252630535
- PLACEBO_TIMING: OK, fidelity_matched=True, equity_last=20822.54334817222
- RISK_EXPOSURE_ATTRIBUTION: OK

## 5. Decay D1/D2/D3 (RA07.4)
- rows: 41 total, by kind: {'D1_IS_TO_OOS': 28, 'D2_PARAMETER_AGE': 5, 'D3_ADJACENT_OPERATIONAL_FOLDS': 8}
...
- secondary Holm family: {"cell1: M4_REGIME - M4_CAL": {"raw_p": 0.4472, "holm_adjusted_p": 0.4472}, "cell1: M4_CAL_MATCHED - M4_CAL": {"raw_p": 0.1452, "holm_adjusted_p": 0.2904}, "cell2: M4_REGIME - M4_CAL_MATCHED": {"raw_p": 0.0788, "holm_adjusted_p": 0.2364}}
...
- leave-one-cell-out: {"cell1_alone": {"point_estimate": 0.00010749611360878338, "ci_95": [-2.3388865982025994e-05, 0.00030376434689337214]}, "cell2_alone": {"point_estimate": 6.559646367014635e-05, "ci_95": [-3.183454694425751e-06, 0.00016201315811124298]}, "pooled_2_cell_aggregate": {"computed": false, "reason": "no pre-registered partial-scope capital weighting exists"}, "agreement": {"same_sign": true}}

## 10. Exit-gate matrix
| Gate | Expected | Actual | Evidence ref | Status |
|---|---|---|---|---|
| G07-VALID | PASS | PASS | ra07-20260919T071527Z-4463ccde/phase_manifest.json | PASS |
| G07-CONTROL | PASS | PASS | ra07-20260919T071527Z-4463ccde/phase_manifest.json | PASS |
| G07-STATS | PASS | PASS | ra07-20260919T071527Z-4463ccde/phase_manifest.json | PASS |
| G07-DECAY | PASS | PASS | ra07-20260919T071527Z-4463ccde/phase_manifest.json | PASS |
| G07-CLAIM | PASS | PASS | ra07-20260919T071527Z-4463ccde/phase_manifest.json | PASS |
| G07-MANIFEST | PASS | PASS | ra07-20260919T071527Z-4463ccde/phase_manifest.json | PASS |
