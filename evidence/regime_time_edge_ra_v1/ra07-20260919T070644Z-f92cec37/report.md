...
- **conclusion_level: INCONCLUSIVE_SUPPORT** (registered vocabulary, guide 13.5's claim-gate table;
  ...
  can carry).
- Branch `mode4-corrective`, guide RA-GUIDE-1.0 (section 11), study `regime_time_edge_ra_v1`, run `ra07-20260919T070644Z-f92cec37`.
...
|---|---|---|---|---|
| G07-VALID | PASS | PASS | ra07-20260919T070644Z-f92cec37/phase_manifest.json | PASS |
| G07-CONTROL | PASS | PASS | ra07-20260919T070644Z-f92cec37/phase_manifest.json | PASS |
| G07-STATS | PASS | PASS | ra07-20260919T070644Z-f92cec37/phase_manifest.json | PASS |
| G07-DECAY | PASS | PASS | ra07-20260919T070644Z-f92cec37/phase_manifest.json | PASS |
| G07-CLAIM | PASS | PASS | ra07-20260919T070644Z-f92cec37/phase_manifest.json | PASS |
| G07-MANIFEST | PASS | PASS | ra07-20260919T070644Z-f92cec37/phase_manifest.json | PASS |
