...
DEFECTS = [
    ...
    {"id": "COR-13", "phase": "LAB-09",
     ...
     "invalidated": "the ABSOLUTE net-return level of every account in LAB-04, LAB-06, LAB-07 "
                    "and LAB-08. Measured on the development window at the registered fee, the "
                    "registered contrasts move by at most 5% and none crosses the minimum "
                    "economic effect, so no CONCLUSION is invalidated -- that is a measurement "
                    "(configs/lab09_development_replay.json as_declared_economics), not a "
                    "reassurance",
     "changed": None,
